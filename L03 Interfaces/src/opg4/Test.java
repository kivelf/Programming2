...
public class Test {
    public static void main(String[] args) {
        ...
        Customer c3 = new Customer("Jullie", LocalDate.of(1973, 4, 5));
        ...
        Discount discount3 = new AgeDiscount(c3);
        c3.setDiscount(discount3);
        ...
        c3.addOrder(o7);
        System.out.println("Customer 3's order summary:");
        c3.printPricesForOrdersWithAndWithoutDisount();
    }
}
