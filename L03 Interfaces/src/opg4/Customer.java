...
public class Customer {
    ...
    public double totalBuyWithDiscount(){
        if (discount != null){
            double total = 0;
            for (Order o : orders){
                total += o.getOrderPrice() - discount.discountedPrice(o.getOrderPrice());
            }
            return total;
        }
    ...
    public void printPricesForOrdersWithAndWithoutDisount(){
        if (discount == null){
            ...
            for (Order o : orders){
                ...
                if (discount.discountedPrice(o.getOrderPrice()) != 0){
                    System.out.println("The total price of the order with discount is: " + (o.getOrderPrice() - discount.discountedPrice(o.getOrderPrice())) + " kr.");
                }
            }
        }
    }
